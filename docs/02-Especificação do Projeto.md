...
|RF-011| A tela de Alterar Item deverá ter os campos: Título do Item; Categoria; Inserir Imagem.   | Alta |
|RF-012| O botão de Excluir Item deverá excluir o item do card.   | MÉDIA  |
|RF-013| A tela de Visualizar Item permitirá o usuário visualizar os campos: Imagem do item; Título do Item; Categoria   | MÉDIA |
